(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider__slider-swiper")) new core(".slider__slider-swiper", {
    ...
    function initSlidersGallery() {
        if (document.querySelector(".slider__slider-swiper-gallery")) new core(".slider__slider-swiper-gallery", {
            modules: [ Navigation, Lazy ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
            ...
            navigation: {
                prevEl: ".slider__arrow_left-gallery",
                nextEl: ".slider__arrow_right-gallery"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        async function formSend(e) {
            ...
            if (0 === error) {
                ...
                if (response.ok) {
                    await response.json();
                    modules_flsModules.popup.open("#popup-message-sent");
                    form.reset();
                    form.classList.remove("_sending");
                } else modules_flsModules.popup.open("#popup-message-error");
            } else {
                modules_flsModules.popup.open("#popup-validate");
                form.classList.remove("_sending");
            }
        }
        ...
        function nameTest(input) {
            return !/^[а-яА-ЯёЁa-zA-Z]+ [а-яА-ЯёЁa-zA-Z]+ ?[а-яА-ЯёЁa-zA-Z]+$/.test(input.value);
        }
    }));
    window["FLS"] = true;
    isWebp();
